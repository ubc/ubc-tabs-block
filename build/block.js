...
/* harmony import */ var _deprecation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./deprecation */ "./src/blocks/tab/deprecation.js");
/**
...
registerBlockType('ubc/tab', {
  ...
  deprecated: [{
    ...
    supports,
    save: _deprecation__WEBPACK_IMPORTED_MODULE_3__["v1"]
  }]
});

/***/ }),

/***/ "./src/blocks/tab/deprecation.js":
/*!***************************************!*\
  !*** ./src/blocks/tab/deprecation.js ***!
  \***************************************/
/*! exports provided: v1 */
...
const InnerBlocks = wp.blockEditor.InnerBlocks; // 1. Because in version 1.0.0 a11y-accordion-tabs fixed the typo from accordeon to accirdion. We need to apply similliar fix to make it work.
...
const Edit = props => {
  ...
  const _useContext = useContext(_tabs_context__WEBPACK_IMPORTED_MODULE_0__["default"]),
        ...
        childTabIds = _useContext.childTabIds,
        tabs = _useContext.tabs; // Tab block does not allowed tabs block or tab block to be nested inside.
...
/* harmony import */ var _deprecation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./deprecation */ "./src/blocks/tabs/deprecation.js");
...
/***/ "./src/blocks/tabs/deprecation.js":
/*!****************************************!*\
  !*** ./src/blocks/tabs/deprecation.js ***!
  \****************************************/
/*! exports provided: v1 */
...
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./context */ "./src/blocks/tabs/context.js");
...
const Edit = props => {
  ...
  const tabs = attributes.tabs,
        initialTabSelected = attributes.initialTabSelected,
        className = attributes.className,
        blockInitialized = attributes.blockInitialized; // Keep current selected tab in editor as a state defaults to initialSelected tab attribute.
  ...
  useEffect(() => {
    if (!blockInitialized) {
      setAttributes({
        ...
        tabs: lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(tabs)
      });
    }
  }, []);
  /**
  ...
  const updateSingleTabTitle = (key, title) => {
    const tabsClone = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(tabs);
  ...
  const renderToolbar = key => {
    ...
    React.createElement(Button, {
      onClick: event => {
        ...
        const newTab = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(tabs);

        var _ref = [newTab[key], newTab[key - 1]];
        newTab[key - 1] = _ref[0];
        newTab[key] = _ref[1];
        setAttributes({
          tabs: newTab
    ...
    React.createElement(Button, {
      onClick: event => {
        ...
        var _ref2 = [newTab[key + 1], newTab[key]];
        newTab[key] = _ref2[0];
        newTab[key + 1] = _ref2[1];
        setAttributes({
          tabs: newTab
    ...
    React.createElement(Button, {
      onClick: event => {
        ...
        const remainingTabs = tabs.filter((title, index) => key !== index);
        setAttributes({
          tabs: remainingTabs
      ...
      function () {
        var _ref3 = _asyncToGenerator(function* (event) {
          ...
          yield insertBlock(wp.blocks.createBlock('ubc/tab', {
            index: childTabIds.length
          }), childTabIds.length, rootId); // Add a new title into the title array.
  ...
  return (
    ...
    /*#__PURE__*/
    React.createElement(_context__WEBPACK_IMPORTED_MODULE_1__["default"].Provider, {
      value: {
        currentTabSelected,
        childTabIds,
        tabs
